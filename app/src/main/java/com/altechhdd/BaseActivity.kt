...
import com.altechhdd.room.Database
import com.altechhdd.room.GetScannedCoilDao
...
open class BaseActivity : AppCompatActivity() {
    ...
    lateinit var getscannedcoil: GetScannedCoilDao

    private var progressDialog: ProgressDialog? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        session = Session(this)
        db = Room.databaseBuilder(applicationContext, Database::class.java, AppConstants.ROOM_DB)
            .allowMainThreadQueries().build()
        getscannedcoil = db.coilDao()
        disableAutoFill()
    }
